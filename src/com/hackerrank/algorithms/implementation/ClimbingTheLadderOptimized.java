...
public class ClimbingTheLadderOptimized {
    ...
    static int[] climbingLeaderboard(int[] scores, int[] alice) {
        ...
        for (int i = 0; i < alice.length; i++) {
            ...
            for (int j = 0; j < linkedScoresList.size(); j++) {
                ...
                int index = Collections.binarySearch(linkedScoresList, alice[i]);
                ...
                if (alice[i] > linkedScoresList.get(j)) {
                    ...
                    linkedScoresList.add(linkedScoresList.size(), alice[i]);
                    result[i] = linkedScoresList.size();
                    break;
                }
